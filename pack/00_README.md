...
`43_PACK_RULES_CONSOLIDATED.md` is the post–six-act-audit index of hard-won standing rules (plate MD5 audit, frame-relative, sole brief authority, moment-not-topic, carrier / Deac / 112 / Act VI geography, citations, IV-018 / II-027 Claude locks). Cross-links the numbered pack sources; does not replace them. **Act VII stays CLOSED** — do not scaffold VII cards from it.
