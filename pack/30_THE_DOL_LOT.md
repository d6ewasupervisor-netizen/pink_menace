...
Locked 8 Sep 2026. Cards `I-006` through `I-009` are the lot. Seeded with the Act I frame (`I-001`–`I-005`, `I-010`–`I-015`). The frame has no stills yet. Stills chosen (`cards/I-006.png` take 2, `I-007.png` take 1, `I-008.png` take 13, `I-009.png` take 2). The near arm on I-008 is Ali's: warm medium-brown skin, half African American, faded pink sleeve. Her face is not in that frame. Do not seed until a full Act I start exists. Probe already returned: A4 and A5 pass. See `29_QUIET_RENDER_PROBE.md`. Do not re-run it for this sequence.
