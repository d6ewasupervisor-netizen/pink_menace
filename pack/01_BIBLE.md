...
- **Vehicle: THE PINK MENACE.** Baja-converted VW Beetle. Faded matte pink with oxidation. Riveted raw-steel door and quarter-panel plating. Welded steel mesh cages over every window and the windshield. Black tube bull bar with a wide flat plow blade. Oversize knobby tires, chrome slot wheels. Interior: cracked pink dash, worn black leather wheel, **round analog gauge cluster (needles only — no digital speed readout, no `112.0`, no highway-speed LED in the hub)**, aftermarket nav tablet (dark / non-competing unless the brief names a map), rocker switch bank. `refs/ref_cockpit.jpg` is poisoned (112.0 + desert GPS) — do not attach on Menace cockpit stills.
