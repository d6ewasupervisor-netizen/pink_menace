...
- `ref_ribbon_workzone.png` — **Act V Ribbon work zone** (wave-C take 1, Claude muted-read PASS). Diagonal cone pinch across the closed right lane; MUTCD orange exempt from world grade. Continuity token `ribbon_workzone`. Wave-C take-2 is the PASS runner — do not attach.
