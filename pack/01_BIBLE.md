...
| `POV_MIRROR_DOOR` | Left-side door mirror, subject in the glass, vehicle flank in foreground | Blind zones, lane changes, backing sightlines. **On the Ledger this is the only rearward camera.** |
