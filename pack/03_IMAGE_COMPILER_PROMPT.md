...
| Ribbon work zone (Act V; V-008, V-009) | `ref_ribbon_workzone.png` — wave C take 1. Continuity token `ribbon_workzone`. Diagonal MUTCD-orange cone pinch across the closed lane; orange exempt from world grade. Wave-C take-2 is runner-up only — do not attach. |
