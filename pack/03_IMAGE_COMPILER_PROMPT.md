...
| Ribbon tractor-trailer (Act V; V-006, V-007) | `ref_ribbon_rig.png` — take 1. Continuity token `ribbon_rig`. Period-aged conventional cab, west-coast mirrors, passenger-car scale. Take-2 FAIL — do not attach. |
| Ribbon work zone (Act V; V-008, V-009) | `ref_ribbon_workzone.png` — wave-C take 1. Continuity token `ribbon_workzone`. Diagonal cone pinch across the closed right lane; workers + portable barrier past the taper. MUTCD orange exempt from world grade. Wave-C take-2 is the PASS runner — do not attach. |
