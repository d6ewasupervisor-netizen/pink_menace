...
**Stock-glass-first.** Build from an intact factory hatchback, then add exterior mods. Do **not** put stripping, gutting, a roll cage, a bucket seat, or a welded rear bench in this brief — those are interior facts and belong only in Y4. Six takes with that wording opened the cabin.

> Cinematic photoreal still, vehicle reference sheet. Four views of the same vehicle in one frame on a plain flat gray backdrop, evenly spaced, identical lighting: front three-quarter, rear three-quarter, full side profile, and straight-on front. Even soft daylight, low contrast, desaturated. Subject: a stock compact hatchback with ALL FACTORY WINDOW GLASS INTACT AND IN PLACE — windshield, front and rear side windows, rear hatch glass, all closed and unbroken. Matte black with tape-patched panels. Retroreflective silver chevron striping across both doors and the tailgate. A tubular roof frame carrying four chrome PA horn flares aimed forward and outward. Low wide stance, dropped ride height, factory door mirrors. Fine grain, no HDR, no glow.
>
> *[negative block]* plus: no open cabin, no missing windows, no stripped glass, no roll cage visible, no race car, no rally car, no gutted interior, no window nets, no bare door frames, no exposed tube frame. · Aspect ratio 16:9

If a take still fails the front-on windshield, do not regenerate the old brief. Composite that one panel from `refs/ref_encore_sheet_y3_take9.png` (glass on the other three views).

## Y4 — ENCORE cockpit
*(attach the chosen Y3 — Y3 take 12 glass lock only. Do not attach an open-cabin cockpit plate.)*

**Intact glass is required and stated first.** Y4 take 4 rendered an open tube frame with weather coming straight in. The four-view lock already has factory glass; this plate must match that treatment. Cage and bench belong inside the enclosed cabin.

> Cinematic photoreal still. 35mm full-frame equivalent, f/2.0, shallow depth of field. REQUIRED ELEMENT, FIRST: intact factory windshield glass — a continuous real sheet of glass filling the entire windshield opening, with a rubber gasket, windshield header, and A-pillars. Raindrops and reflections sit on the OUTSIDE surface of that glass, proving the glass is there. The cabin is fully enclosed: solid roof headliner, no sky where the roof should be. Weather stays outside. Overcast Pacific Northwest daylight through that glass — soft, diffuse, low-contrast, gray-blue. Desaturated palette; the only bright element is retroreflective silver-white. Camera inside the vehicle, over the wheel, looking forward THROUGH the intact glass. A small suede-wrapped racing steering wheel across the bottom of frame. Stripped dashboard, bare metal, exposed wiring loomed and taped, a single aftermarket tachometer, a toggle-switch panel with one large guarded red switch clearly separate from the others. Welded roll cage tubing crossing the A-pillars — the cage belongs inside this enclosed cabin. A sliver of the mismatched welded rear bench is visible behind the wheel. Beyond the glass, wet empty city street under flat gray sky. A dead wireless handheld microphone clipped to the cage tube at the right edge of frame. Fine grain, slight vignetting, no HDR, no glow, no lens flare.
>
> *[negative block]* plus: no open cabin, no bare apertures, no missing windshield, no stripped glass, no weather coming straight in, no convertible, no sky where the roof should be, no open tube-frame cockpit, no formula car, no dune buggy, no mesh, no bars across the glass, no PA horns inside the cabin. · Aspect ratio 2:3
