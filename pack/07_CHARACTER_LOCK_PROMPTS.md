...
> Cinematic photoreal still, vehicle reference sheet. Four views of the same vehicle in one frame on a plain flat gray backdrop, evenly spaced, identical lighting: front three-quarter, rear three-quarter, full side profile, and straight-on front. Even soft daylight, low contrast, desaturated. Subject: a compact hatchback with a low wide wedge silhouette, matte black with tape-patched panels, retroreflective silver chevron striping salvaged from highway signs running across both doors and the tailgate. Every window opening is filled with intact closed window glass — windshield, front side windows, rear side windows, and rear hatch glass are all present as real transparent glass panes with specular reflections and slight refraction. The gutted interior and exposed welded roll cage are visible THROUGH the glass, never through empty holes. One bucket seat and a mismatched welded-in rear bench from a different car, seen through the glass. A tubular roof frame carrying four chrome PA horn flares aimed forward and outward. No window mesh, no window bars, no armor plating. Wide low-profile tires, ride height dropped. Fast, fragile, loud. Fine grain, no HDR, no glow.
>
> *[negative block]* · Aspect ratio 16:9
