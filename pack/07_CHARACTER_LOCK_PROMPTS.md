...
Locked plate: `cards/takes/encore-footwell-take-6.png` → `refs/ref_encore_footwell.png`. Human-verified PASS by Claude 2026-09-11. Continuity token `encore_footwell` must resolve through `scripts/compile-images.js` — a `/tmp/pm-plates/` comment is not attach.
...
| Encore footwell | `ref_encore_footwell.png` |
