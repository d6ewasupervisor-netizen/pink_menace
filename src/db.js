...
async function migrate() {
  ...
  `);
  await pool.query(`
    ALTER TABLE runs ADD COLUMN IF NOT EXISTS review_plan JSONB NOT NULL DEFAULT '[]'::jsonb
  `);
  await pool.query(`
    ALTER TABLE runs ADD COLUMN IF NOT EXISTS review_index INTEGER NOT NULL DEFAULT 0
  `);
  await pool.query(`
    DO $$
    DECLARE r RECORD;
