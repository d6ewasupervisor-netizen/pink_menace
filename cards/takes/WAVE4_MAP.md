...
| **V-012** | Three Seconds Here Too | `POV_DIAGRAM` | **take 6** `V-012-take-6.png` | take 5 `V-012-take-5.png` |
...
- **V-012 take 6:** three lanes, concrete median, sedan in the middle, Beetle/box in the right; no speedometer / sign icons; no caption. Residual: no stain; sedan almost even with the Beetle (gap weaker).
- **V-012 take 5 (runner):** sedan + Beetle + box; dark pavement stain as a fixed count mark. Residual: two-lane + yellow; stain sits in the sedan's lane, not a third middle lane; gap shorter than four lengths.
...
- **V-012 take 6** → `cards/V-012.png` (live-DB). Take 5 remains runner — not seeded.

Do not seed V-009 / V-010 / V-013 / V-007. No Acts I–III.
