...
Seeded live: V-013←take-5, V-008←take-3, V-006←take-3. V-008 take-1 not seeded. Plates stay in their own PRs.

| Card | Plate | Closest | Runner | Discard |
|---|---|---|---|---|
| V-013 | `ref_ribbon_deck` take-4 | **take 5 PASS (live)** | take 3 | take 2 (frontal / plow at lens); take 4 (wrong face, red lamps, wide pad) |
...
- **V-013 take 5:** shoulder is the fog-line / Jersey squeeze (part of the car on the live line) — closer to the plate than take 1. Curve is still a long straight deck with only a weak far bend. Dusk leans late (streetlights on, sky gray not black). Ali is a mesh silhouette, not a clear belted read. Camera is three-quarter-ish, not a hard offset from the travel lane.
...
- **V-013** — EXACT Claude JSON. Brad PASS promote take-5; take-3 banked. Master `cards/V-013.png`. QP-003 mute-read (not seeded): **take 6 closest** = take-5 plate + two Quiet silhouettes at the far right shoulder / curve; **take 7 runner** = same dressing on take-3. Alias `V-013-take-5-quiet.png` = take 6. Live master stays take-5.
