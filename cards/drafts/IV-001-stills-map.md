...
**Reshoot notes (brake — this pass):**
- Take 13 FAILed a third time: foot flat on the floor mat well to the right of both pedals. Stop new free prompts.
- Ideal pedal box: `cards/takes/IV-003-take-1.png` — foot suspended above the brake with a visible air gap; other pedal empty.
- Preferred path: composite that pedal box into the locked Encore interior (Y4 take 7 / `refs/ref_encore_cockpit.png`), or compile with IV-003-take-1 attached as the hard pedal-region ref.
- Do not put the sole on the floor. Covering the brake is a hover, not a plant.
- Person take 16 / tracks take 7 stay from PR #27 — not reshot here.
- No `cards/IV-001.json` — prompts are hand-assembled from this map. Not seeded.
...
```json
{
  "slug": "IV-001-brake",
  "camera": "POV_OBJECT",
  "camera_pose": "Camera is low in the left-hand-drive driver footwell, near the dead pedal, looking down and slightly forward at the pedal box. Match IV-003-take-1 for the pedal-box composition. The brake pedal occupies the center of the FRAME. Intact windshield and a distant traffic light occupy only the top fifth of the FRAME, out of focus. No faces.",
  "subject": "a right foot in a black high-top covering the brake pedal, held still, not pumping, not riding the pedal — suspended above the brake with a visible air gap between sole and pedal face. The gas pedal to the right of the brake is empty — no foot on it. Do not put the sole on the floor.",
  ...
  "midground": "the hovering foot and ankle, a sliver of black track pant; the empty gas pedal; the air gap over the brake",
  ...
  "read": "the right foot covers the brake and is held; the gas is empty; the air gap is visible",
