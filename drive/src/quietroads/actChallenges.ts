...
export const ACT_CHALLENGES: Record<CardAct, ActChallenge> = {
  ...
  V: {
    ...
    vehicle: "the Menace — Grandma's pink Beetle with the plow blade",
    cargo: 'Relay kit — repeater, antenna, clamps',
    missions: ['mission_ribbon_merge', 'mission_convoy_issaquah', 'convoy_continue_solo', 'convoy_tow_jonah', 'chainup_qte'],
  ...
  VI: {
    ...
    missions: ['mission_backcountry_run', 'straight_night_drive', 'rest_area_pullin', 'rest_area_forced', 'vantage_bridge_crossing', 'bridge_after_sign_toy', 'bridge_after_sign_moth', 'bridge_engine_off_wait'],
