...
- Default: nacelle angled away (no glyphs). Alternate: one period-correct dial
  when the card brief names a needle

**Encore (adjacent, not a contradiction):** automatic, two pedals, no clutch.
Already locked via `ref_encore_cockpit.png` (Y4 b-take-2).

## Act V

Wave-2 FAIL notes (112.0 gauge + tablet/GPS gibberish) compiled against
`ref_cockpit.jpg`. Next V-001 / V-002 compiles attach this plate. No stills
regen in the map PR. No Acts I–III card edits.
