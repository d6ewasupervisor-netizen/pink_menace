# NEXT — Claude muted-read of released cabin stills

Menace interior plate is **promoted** (take 16, human-verified).
`pink_menace_interior` → `refs/ref_menace_cabin.png`
`sha256:3576270ee32f8759060cf63cfdf7a74e4ed32308f3907696bce0de4ef24c5a46`

**Menace = manual, floor shifter, three pedals.**
**Encore = automatic, two pedals, no clutch** (footwell take-6 / Y4 take-1).
Y4 take 7 is not cockpit authority (PR #74).
...
| IV-028 | both cats' faces are at the grate of the closed strapped carrier; the strap and latch are readable; the street ahead is ordinary | `POV_COCKPIT` | carrier-close regen incoming — do not use take-15 (cats on the seat) |
