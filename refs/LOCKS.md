...
| Encore cockpit | **Y4 take 4** (provisional) | `ref_encore_cockpit.png` | Enclosed roof, no interior PA horns, wet downtown through the opening, mic on the right cage tube. Glass still needs Claude — raindrops did not land on this plate (see IV-002 take 3 for rain-on-glass). Old open-air lock archived as `ref_encore_cockpit_y4_take1.png`. Takes 1–3: take 1 has switch-label text; take 2 is a cabin overview; take 3 has Seattle but a more open hole. Interior cage and bench belong here; they must not appear in exterior briefs. |
