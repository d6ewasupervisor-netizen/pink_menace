...
Claude locked three NEW plate briefs. All three promoted. Deck + rig from PR #149 muted-read. Workzone from wave-C: take-1 promote/closest; take-2 PASS runner (not attached).
