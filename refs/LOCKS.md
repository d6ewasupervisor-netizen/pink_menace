...
## Encore footwell — proposed lock (pending human verify)
...
| **6 (closest)** | `cards/takes/encore-footwell-take-6.png` | **2** | Wide diamond brake + narrow ribbed gas. Empty floor left of brake. Painted heel zone, no pink mat. Y4 cluster / red switch / cage / rain glass. |
...
Do not seed live. Do not run IV-001-brake regen until a human accepts this plate.
