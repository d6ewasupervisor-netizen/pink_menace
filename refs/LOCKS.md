...
| Cover-the-brake posture | IV-001-brake take 81 (Claude PASS) | `ref_brake_cover.png` | Seeded named-spot plate (`cards/takes/IV-001-brake-take-81.png`). **Posture only:** heel planted below the pad, ball hovering with daylight. Dark Encore cabin, black high-top, and **two-pedal** box are not Menace authority. Auto-attaches when the brief names covering the brake. |
