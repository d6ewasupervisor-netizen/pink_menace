...
| Encore cockpit | **Y4 take 7** (glass lock) | `ref_encore_cockpit.png` | Intact windshield glass: rain beads on the outside, enclosed roof, over-the-wheel, cage inside. Take 4 was an open tube frame (FAIL). Take 8 has stronger glass proof (rearview on the glass) but invents a second Encore — do not attach it as the lock or it bleeds. Take 5 proves glass on the side window (wrong camera). Do not attach take 4. Interior cage and bench belong here; they must not appear in exterior briefs. |
