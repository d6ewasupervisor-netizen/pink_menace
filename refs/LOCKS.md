...
| Ribbon work zone | wave-C take 1 | `ref_ribbon_workzone.png` | Claude muted-read **PASS** (image-review 2026-09-12) on wave-C take-1 — **PROMOTE**. Take-2 **PASS** as runner only. Diagonal cone pinch across the closed right lane (not a longitudinal shoulder line). MUTCD orange exempt from world grade. Exact promote of `refs/candidates/ribbon-workzone-c-take-1.png`. `sha256:bf9d9462be460ea6e655ca8596a5734cb624bd2cbeadb5932434c1eaeee116a6`. Serves V-008, V-009. Continuity token `ribbon_workzone`. Wave-C take-2 runner stays at `refs/ref_ribbon_workzone_candidate_runnerup.png` — do not attach. |
...
Claude locked three NEW plate briefs. All three promoted. Deck + rig from PR #149 muted-read. Workzone from wave-C: take-1 **PASS PROMOTE**; take-2 **PASS** runner (not attached).
...
# ref_ribbon_workzone  take-c-1 sha bf9d9462be460ea6e655ca8596a5734cb624bd2cbeadb5932434c1eaeee116a6  PROMOTED. Diagonal pinch. MUTCD orange exempt.
```

Pool: `refs/candidates/ribbon-*-take-N.png` plus closest/runner copies `refs/ref_ribbon_*_candidate.png`. Workzone wave-C runner: `refs/ref_ribbon_workzone_candidate_runnerup.png` (`ribbon-workzone-c-take-2.png`). Brief: `refs/CANDIDATE_RIBBON.md`.
