...
| Pink Menace exterior | lock sheet | `ref_car_exterior.jpg` | Front three-quarter silhouette and build. **nose_plow: standard plate equipment** — wide flat blade on the black tube bull bar at the far leading / nose end. Not scene-optional. Not left-flank / side-mounted. Also mesh, riveted door plate, knobbies. The salt-flat sunset in this frame is **not** the game's lighting. Lossless copy: `ref_car_exterior.png`. Compiles also attach `ref_car_sheet.png`. |
| Pink Menace four-view | sheet take 1 | `ref_car_sheet.png` | Same file as `cards/takes/menace-sheet-take-1.png`. Gray-studio four-view: front 3/4, rear 3/4, side, straight-on front. **The plate the model sees for plow geometry.** Rear 3/4: wide flat blade on the black tube bull bar at the far leading / nose end. Side: blade at the nose, not the flank. Takes 2–3 put a residual blade on the rear/flank — discard. Take 4 runner-up. |
...
| Diagram language | style lock | `ref_diagram_style.png` | Optional. Overhead photoreal look. Ali diagrams attach `ref_car_sheet.png` and `ref_car_exterior.jpg` for Beetle build and plow. Deac diagrams attach `ref_ledger_sheet.png` and never a Menace ref. |
...
|---|---|
| `ref_car_sheet.png` | Four-view. Rear 3/4 teaches plow at the far leading end — the IV-026 camera. Attach first. |
| `ref_car_exterior.jpg` | Front 3/4 hero. Nose plow is present here; salt-flat sunset is **not** the game's lighting. |

Do not attach a rear-mounted plow plate. Dedicated rear takes 4–5 put the blade on the engine lid — that is the wrong end.
