...
| Encore cockpit | **Y4 take 7** (glass lock) | `ref_encore_cockpit.png` | Intact windshield glass: rain beads on the outside, enclosed roof, analog cluster, guarded red switch, cage inside. Take 1 / take 4 are open tube frames (FAIL) — do not attach them. Same file as `cards/takes/Y4-take-7.png`. |
