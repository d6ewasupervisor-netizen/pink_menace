...
3. Act IV starts on **IV-002**. Act V starts on **V-001**. Sequence skips unsown numbers, including **V-009**.
...
## Live Act V cards (12; V-009 missing)
...
**V-009 is not live.** Hands regen [PR #192](https://github.com/d6ewasupervisor-netizen/pink_menace/pull/192) is awaiting Claude PASS. The run skips it.
...
- **V-009** — hole in The Ribbon. Do not invent a still.
