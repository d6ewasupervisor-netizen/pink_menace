...
const MENACE_PLOW =
  "Nose plow: match the attached overcast plate ref_car_nose_plow.png. The plow is a full-width nose blade on the front black-tube bull bar, in front of both front wheels; no flank-mounted blade; no blade on a corner; no blade on the rear or engine lid. Preserve on the Menace: welded steel mesh cages on the side glass and the windshield; a riveted metal door panel; oversize knobby tires on chrome slot wheels; faded matte pink with bare-metal / oxidized steel plating. Use ref_car_exterior.jpg for Beetle silhouette and build only; never carry its salt-flat sunset. Never attach ref_car_rear_plow.jpg or any flank / corner plow plate.";

const MENACE_PLOW_NEGATIVE =
  "No side-mounted plow, no flank-mounted blade, no left-flank blade, no corner-mounted blade, no blade on a side arm ahead of the front wheel, no plain tube bumper without a blade, no rear-mounted plow, no blade on the engine lid, no plow welded onto the rear of the Beetle.";
