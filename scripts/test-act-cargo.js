...
assert.strictEqual(cargoDead({ time_cost: 140 }, { time_cost: 4 }, "V"), false, "Act V clock-out is not a hard fail");
assert.strictEqual(cargoDead({ time_cost: CARGO_BUDGET }, { fatal: true }, "V"), false, "Act V is not instantly fatal");
